...
- [ ] T002 [P] Add new domain exceptions to `src/fund_transfer/core/exceptions.py`: `StaleRateError` (HTTP 503), `RateDeviationError` (HTTP 409, includes preview_rate/current_rate/deviation_pct/new_snapshot_id), `UnsupportedCurrencyPairError` (HTTP 422), `TransferLimitExceededError` (HTTP 422, includes limit_type: "per_transaction"|"per_day", limit_usd: Decimal, attempted_usd: Decimal — SEC-002)
